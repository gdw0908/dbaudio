...
<div id="sub">
  <div class="contents">
    ...
    <div class="section" style="padding:15px 0 0 0;">
      <p class="first"><strong>안녕하세요. &lt;페어링&gt;입니다.</strong></p>
      <p>2021년 10월 15일부터 페어링 쇼핑몰 사이트에 게시된 전자우편(e-mail)주소를 전자우편 수집 프로그램이나 그 밖의 기술적 장치를 이용하여 무단으로 수집하는 것을 거부하며, 이를 위반 시 정보통신망이용 촉진 및 정보보호 등에 관한 법률(＇이하＇ 정보통신망법)에 의해 형사 처벌됨을 유념하시기 바랍니다.</p>
